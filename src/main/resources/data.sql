...
insert into products(id, name, price, category_id, producer_id) values
                                   (gen_random_uuid(), 'pletwy nr 1', 100.00,(select id from categories where name='Fins'), (select id from producers where name='TECLINE')),
                                   (gen_random_uuid(), 'pletwy nr 2', 150.00, (select id from categories where name='Fins'), (select id from producers where name='SEAC')),
                                   (gen_random_uuid(), 'pletwy nr 2', 150.00, (select id from categories where name='Fins'), (select id from producers where name='SEAC')),
                                   (gen_random_uuid(), 'pletwy nr 2', 150.00, (select id from categories where name='Fins'), (select id from producers where name='SEAC')),
                                   (gen_random_uuid(), 'pletwy nr 2', 150.00, (select id from categories where name='Fins'), (select id from producers where name='SEAC')),
                                   (gen_random_uuid(), 'pletwy nr 2', 150.00, (select id from categories where name='Fins'), (select id from producers where name='SEAC')),
                                   ...
                                   (gen_random_uuid(), 'pletwy nr 2', 150.00, (select id from categories where name='Fins'), (select id from producers where name='SEAC')),
                                   (gen_random_uuid(), 'pletwy nr 2', 150.00, (select id from categories where name='Fins'), (select id from producers where name='SEAC')),
                                   (gen_random_uuid(), 'pletwy nr 3', 200.00, (select id from categories where name='Fins'), (select id from producers where name='TUSA')),
                                   (gen_random_uuid(), 'pletwy nr 1', 100.00,(select id from categories where name='Fins'), (select id from producers where name='TECLINE')),
                                   (gen_random_uuid(), 'pletwy nr 2', 150.00, (select id from categories where name='Fins'), (select id from producers where name='SEAC')),
                                   (gen_random_uuid(), 'pletwy nr 3', 200.00, (select id from categories where name='Fins'), (select id from producers where name='TUSA')),
                                   (gen_random_uuid(), 'pletwy nr 3', 200.00, (select id from categories where name='Fins'), (select id from producers where name='TUSA')),
                                   (gen_random_uuid(), 'pletwy nr 3', 200.00, (select id from categories where name='Fins'), (select id from producers where name='TUSA')),
                                   (gen_random_uuid(), 'pletwy nr 3', 200.00, (select id from categories where name='Fins'), (select id from producers where name='TUSA')),
                                   (gen_random_uuid(), 'automat nr 1', 199.00, (select id from categories where name='Automaty oddechowe'), (select id from producers where name='APEKS')),
                                   (gen_random_uuid(), 'automat nr 2', 200.00, (select id from categories where name='Automaty oddechowe'), (select id from producers where name='TECHNISUB')),
                                   (gen_random_uuid(), 'automat nr 3', 201.00, (select id from categories where name='Automaty oddechowe'), (select id from producers where name='APEKS')),
                                   (gen_random_uuid(), 'automat nr 4', 1.00, (select id from categories where name='Automaty oddechowe'), (select id from producers where name='GUI')),
                                   (gen_random_uuid(), 'skafander nr 1', 15000.00, (select id from categories where name='Dry suits'), (select id from producers where name='SANTI')),
                                   (gen_random_uuid(), 'skafander nr 2', 10000.00, (select id from categories where name='Dry suits'), (select id from producers where name='AQUA ZONE')),
                                   ...
                                   (gen_random_uuid(), 'maska nr 1', 300.00, (select id from categories where name='Masks'), (select id from producers where name='SEAC')),
                                   (gen_random_uuid(), 'maska nr 2', 200.00, (select id from categories where name='Masks'), (select id from producers where name='HOLLIS')),
                                   (gen_random_uuid(), 'maska nr 3', 140.00, (select id from categories where name='Masks'), (select id from producers where name='OMS'));